                            ...
                            <tbody>
                                @foreach ($order->orderItems as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="{{ route('messages.show', $item->product->user) }}">{{ $item->product->user->name }}</a>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            @if ($item->status === 'delivered' && $item->key_data)
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="key-{{ $item->id }}">รหัสเกมของคุณ</label>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                @if (!$item->product->reviews->where('user_id', auth()->id())->first())
                                                                    <button type="button" class="btn btn-alt-success"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#modal-review-{{ $item->id }}"
                                                ...
                                                <!-- Modal รีวิวผู้ขาย -->
                                                @if (!$item->product->reviews->where('user_id', auth()->id())->first())
                                                    <div class="modal fade" id="modal-review-{{ $item->id }}"
                                                        tabindex="-1" role="dialog"
                                                        aria-labelledby="modal-review-{{ $item->id }}"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <form action="{{ route('reviews.store', $order) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <input type="hidden" name="seller_id"
                                                                        value="{{ $item->product->user_id }}">
                                                                    <div class="modal-header">
                                                                    ...
                                                                    <div class="modal-body">
                                                                                    ...
                                                                                    @for ($i = 5; $i >= 1; $i--)
                                                                                        <div
                                                                                            ...
                                                                                            <label class="form-check-label"
                                                                                                ...
                                                                                                <i
                                                                                                    class="fa fa-star {{ $i <= 5 ? 'text-warning' : '' }}"></i>
                                                                                            </label>
                                                                                        </div>
                                                                                    @endfor
                                                                                </div>
                                                                        ...
                                                                        <div class="mb-4">
                                                                            <label class="form-label"
                                                                                for="comment-{{ $item->id }}">ความคิดเห็น</label>
                        ...
                        @foreach ($reviews as $review)
                            <div class="d-flex push">
                                ...
                                <div class="flex-grow-1">
                                    <div class="fs-sm">
                                        <a
                                            href="{{ route('messages.show', $review->seller) }}">{{ $review->seller->name }}</a>
                                    </div>
                                    <div class="fs-sm text-muted">
                                        @for ($i = 1; $i <= 5; $i++)
                                            <i
