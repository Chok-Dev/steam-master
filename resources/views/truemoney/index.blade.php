                            ...
                            <a href="{{ route('toupTruemoney') }}" class="block block-rounded block-link-shadow h-100 mb-0">
                                <div
                                    ...
                                    <img class="img-avatar img-avatar-thumb"
                                        src="{{ asset('media/photos/truemoneywallet.webp') }}" alt="">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('toupChillpay') }}" class="block block-rounded block-link-shadow h-100 mb-0">
                                <div
                                    ...
                                    <img class="img-avatar img-avatar-thumb" src="{{ asset('media/photos/chillpay.png') }}"
                                        alt="">
                                    ...
                                    <div class="accordion" id="accordionFAQ">
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    เงินที่เติมเข้าระบบไม่มีวันหมดอายุ
                                                    สามารถใช้ได้ตลอดเวลาที่บัญชียังคงอยู่ในระบบ
                                                </div>
                                            </div>
                                        </div>
                                        <div class="accordion-item">
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseThree" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    โดยปกติเงินที่เติมเข้าระบบแล้วจะไม่สามารถถอนคืนได้ อย่างไรก็ตาม
                                                    หากมีกรณีพิเศษ
