                ...
                <div class="block-content">
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            @if($user->avatar)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $user->avatar) }}" alt="{{ $user->name }}" class="img-avatar img-avatar96">
                                </div>
                            @endif
                        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="block block-rounded">
                ...
                <div class="block-content">
                    ...
                    <p>
                        <i class="fa fa-calendar me-1"></i> <strong>เข้าร่วมเมื่อ:</strong> {{ $user->created_at->format('d/m/Y') }}
                    </p>
                    <p>
                        <i class="fa fa-wallet me-1"></i> <strong>ยอดเงินในบัญชี:</strong> {{ number_format($user->balance, 2) }} ฿
                    </p>
                    
                    @if($user->role === 'user')
                        <div class="mt-4">
                            <a href="#" class="btn btn-alt-success btn-sm w-100">
            ...
            <div class="block block-rounded">
                ...
                <div class="block-content">
                    <p>เมื่อบัญชีของคุณถูกลบ ข้อมูลและทรัพยากรทั้งหมดจะถูกลบอย่างถาวร โปรดดาวน์โหลดข้อมูลหรือข้อมูลใดๆ ที่คุณต้องการเก็บไว้ก่อนลบบัญชีของคุณ</p>
                            ...
                            <div class="modal-content">
                                <form action="{{ route('profile.destroy') }}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        <p>คุณแน่ใจหรือไม่ว่าต้องการลบบัญชีของคุณ? เมื่อบัญชีของคุณถูกลบ ข้อมูลและทรัพยากรทั้งหมดจะถูกลบอย่างถาวร การกระทำนี้ไม่สามารถย้อนกลับได้</p>
                                        
                                        <div class="mb-4">
                                            <label class="form-label" for="delete_password">ยืนยันรหัสผ่านของคุณ</label>
                                            <input type="password" class="form-control" id="delete_password" name="password" placeholder="รหัสผ่าน" required>
                                        </div>
