                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mt-3">
                                ...
                                <form id="send-message-form" action="{{ route('messages.show', $order->user) }}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="fw-semibold">
                                                <a
                                                    href="{{ route('admin.products.show', $item->product) }}">{{ $item->product->name }}</a>
                                            </div>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="key-{{ $item->id }}">รหัสเกม</label>
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control"
                                                                                id="key-{{ $item->id }}"
                                                                                value="{{ $item->decryptedKey }}"
                                                                                readonly>
                                                                            <button type="button"
                            ...
                            <tbody>
                                @forelse($order->transactions as $transaction)
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="{{ route('admin.users.show', $transaction->user) }}">{{ $transaction->user->name }}</a>
                                        </td>
                                        <td>
