                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      @if ($item->status === 'pending')
                        ...
                        <!-- Modal ส่งมอบรหัส -->
                        <div class="modal fade" id="modal-deliver-key-{{ $item->id }}" tabindex="-1" role="dialog"
                          aria-labelledby="modal-deliver-key-{{ $item->id }}" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              <form action="{{ route('seller.products.deliver', $item) }}" method="POST">
                                @csrf
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="form-group">
                                  <label for="view-key-{{ $item->id }}">รหัสที่ส่งมอบแล้ว</label>
          ...
          <ul class="timeline timeline-alt">
            ...
            @if ($order->status === 'processing')
              <li class="timeline-event">
                ...
                <i class="fa fa-money-bill timeline-event-icon bg-info"></i>
                <div class="timeline-event-content">
